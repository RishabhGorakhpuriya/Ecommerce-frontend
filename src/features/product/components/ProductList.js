        ...
        <div className="mx-auto max-w-2xl px-4 py-10 sm:px-6 sm:py-8 lg:max-w-7xl lg:px-8">
          <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
            {status === 'loading' ? <Circles
              ...
              wrapperClass=""
              visible={true}
              className="flex justify-center inline-block align-middle"
            /> : null}
              ...
              <Link to={`/product-details/${product.id}`} key={product.id}>
                <div key={product.id} className="group relative border-solid border-2 p-2 border-gray-200 border-radius-5">
                  ...
                  <div className="mt-4 flex justify-between">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">${discountPrice(product)}, %{Math.ceil(product.discountPercentage)}</p>
                      <p className="text-sm font-medium line-through text-gray-600">${product.price}</p>
                    </div>
                  </div>
                  {/* {product.deleted && (<div>
