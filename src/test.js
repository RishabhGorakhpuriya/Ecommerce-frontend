...
// const catergories = [...new Set([...products(p=>p.category)])]
// catergories.map(c=>({value:c, label:c.split('-').join(' '), checked:false}))
//  Set{'smartPhones','laptops', 'home-decoration', 'skincare', 'groceries'}
